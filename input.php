        ...
        <div class="container mt-5">
            ...
            <form action="result.php" method="post" onsubmit="return validarFormularioInput()">
                <div class="form-group">
                    ...
                    <p id="error-lado1" class="text-danger"></p>
                </div>
                <?php if ($tipoFigura == 'Rectangulo' || $tipoFigura == 'Triangulo'): ?>
                    <div class="form-group">
                        <label for="lado2">Lado 2:</label>
                        <input type="number" name="lado2" id="lado2" class="form-control" value="<?= isset($_SESSION['lado2']) ? $_SESSION['lado2'] : '' ?>">
                        <p id="error-lado2" class="text-danger"></p>
                ...
                <?php if ($tipoFigura == 'Triangulo'): ?>
                    <div class="form-group">
                        ...
                        <p id="error-lado3" class="text-danger"></p>
                    </div>

                <?php endif; ?>
                <input type="hidden" id="tipoFigura" value="<?php echo $tipoFigura; ?>">
